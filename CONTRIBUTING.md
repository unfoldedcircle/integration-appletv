...
If you find a bug, please search for it first in the [Issues of this repository](https://github.com/unfoldedcircle/integration-appletv/issues),
...
If it isn't already tracked, [create a new issue](https://github.com/unfoldedcircle/integration-appletv/issues/new).

### New Features :bulb:

If you'd like to see or add new functionality to the library, describe the problem you want to solve in a
[new Issue](https://github.com/unfoldedcircle/integration-appletv/issues/new).
...
- [Create a new issue](https://github.com/unfoldedcircle/integration-appletv/issues/new)
